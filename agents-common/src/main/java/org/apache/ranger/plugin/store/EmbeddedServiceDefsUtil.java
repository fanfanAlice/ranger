...
public class EmbeddedServiceDefsUtil {
	...
	public static final String DEFAULT_BOOTSTRAP_SERVICEDEF_LIST = "tag,hdfs,hbase,hive,kms,knox,storm,yarn,kafka,solr,atlas,nifi,nifi-registry,sqoop,kylin,elasticsearch,presto,ozone,kudu,schema-registry,kyligence";
	...
	public static final String EMBEDDED_SERVICEDEF_KYLIGENCE_NAME  = "kyligence";
	...
	public static final String KYLIGENCE_IMPL_CLASS_NAME  = "org.apache.ranger.services.kyligence.RangerServiceKyligence";
	...
	private RangerServiceDef kyligenceServiceDef;
	...
	public void init(ServiceStore store) {
		...
		try {
			...
			kyligenceServiceDef = getOrCreateServiceDef(store, EMBEDDED_SERVICEDEF_KYLIGENCE_NAME);
	...
	public long getKyligenceServiceDefId() { return getId(kyligenceServiceDef); }
